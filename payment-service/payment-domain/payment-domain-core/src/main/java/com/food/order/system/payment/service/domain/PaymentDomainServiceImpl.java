...
import com.food.order.system.domain.DomainConstants;
...
import com.food.order.system.payment.service.domain.valueebject.CreditHistoryId;
import com.food.order.system.payment.service.domain.valueebject.TransactionType;
...
import static com.food.order.system.domain.DomainConstants.*;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    @Override
    public PaymentEvent validateAndCancelEvent(Payment payment,
                                               CreditEntry creditEntry,
                                               List<CreditHistory> creditHistories,
                                               List<String> failureMessages) {
        payment.validatePayment(failureMessages);
    ...
    private void validateCreditHistory(CreditEntry creditEntry,
        ...
        if (totalDebitHistory.isGreaterThan(totalCreditHistory)) {
            ...
            failureMessages.add("Customer with id:{} doesn't have enough credit according to credit history" +
                    creditEntry.getCustomerId().getValue());
        }
    ...
    private Money getTotalHistoryAmount(List<CreditHistory> creditHistories, TransactionType transactionType) {
        return creditHistories.
                stream().filter(creditHistory -> transactionType == creditHistory.getTransactionType())
